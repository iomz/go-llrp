...
func TestMakeISO17363(t *testing.T) {
	...
	tests := []struct {
		...
		{"A97BCSQU3054383", args{true, "CSQ", "U", "305438"}, []byte{}, 0, "110111000010000011010011010001010101110011110000110101110100110011111000110011", "ISO17363_7B_CSQ_U_305438", false},
		{"A97BCSQU", args{true, "CSQ", "U", ""}, []byte{}, 0, "110111000010000011010011010001010101", "ISO17363_7B_CSQ_U", false},
		{"A97BCSQ", args{true, "CSQ", "", ""}, []byte{}, 0, "110111000010000011010011010001", "ISO17363_7B_CSQ", false},
		{"A97B", args{true, "", "", ""}, []byte{}, 0, "110111000010", "ISO17363_7B", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestMakeISO17365(t *testing.T) {
	...
	tests := []struct {
		...
		{"25SUN043325711MH8031200000000001", args{true, "25S", "UN", "043325711", "MH8031200000000001"}, []byte{}, 0, "110010110101010011010101001110110000110100110011110011110010110101110111110001110001001101001000111000110000110011110001110010110000110000110000110000110000110000110000110000110000110000110001", "ISO17365_25S_UN_043325711_MH8031200000000001", false},
		{"25SUN043325711", args{true, "25S", "UN", "043325711", ""}, []byte{}, 0, "110010110101010011010101001110110000110100110011110011110010110101110111110001110001", "ISO17365_25S_UN_043325711", false},
		{"25SUN", args{true, "25S", "UN", "", ""}, []byte{}, 0, "110010110101010011010101001110", "ISO17365_25S_UN", false},
		{"25SUN", args{true, "25S", "", "", ""}, []byte{}, 0, "110010110101010011", "ISO17365_25S", false},
